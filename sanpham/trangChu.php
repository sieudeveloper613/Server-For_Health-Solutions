...
<?php    
    ...
    inner join types on product.idType = types.idType;";                              
...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        <div class="card-header" >
            <h2 style = "text-align: center">Danh sách tất cả sản phẩm</h2>
         </div>
         <div class="navbar">
         <div class="icon-bar">
          <a class="active" href="index.php?page_layout=trangChu"><i class="fa fa-home"></i></a>
          </div>
         <div class="dropdown">
          <button class="dropbtn" class="active">Sản Phẩm
