...
<?php    
    ...
    inner join types on product.idType = types.idType WHERE product.idCategory = 1;";                              
...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        <div class="card-header" >
            <h2 style = "text-align: center">Danh sách sản phẩm Gia Dụng & Đời Sống</h2>
         </div>
         <div class="navbar">
         <div class="icon-bar">
         ...
         <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a class="active" href="index.php?page_layout=danhSachGiaDung">Gia Dụng & Đời Sống</a>
        ...
        <a href="index.php?page_layout=notications">Trả Lời Khách Hàng</a>
         ...
         <a class="btn btn-primary" href="index.php?page_layout=themGiaDung">Thêm mới</a>
