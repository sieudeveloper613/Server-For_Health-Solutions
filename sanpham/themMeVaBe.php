<?php
    $sql_brand = "SELECT * FROM category WHERE  idCategory = 3";
    $query_brand = mysqli_query($conn, $sql_brand);
    $sql_brand1 = "SELECT * FROM types WHERE idCategory = (SELECT idCategory FROM Category WHERE idCategory = 3)";
    ...
    if(isset($_POST['sbm'])){
        ...
        VALUES ('$nameProduct', '$imageProduct', $priceProduct,'$idCategory' ,'$idType', '$originProduct', '$branchProduct', '$contentProduct')";
            ...
            header ('location: index.php?page_layout=danhSachMeVaBe');
    }
