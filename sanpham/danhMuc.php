...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        ...
        <a href="index.php?page_layout=notications">Trả Lời Khách Hàng</a>
            ...
            $i = 1;
                while($row = mysqli_fetch_assoc($query)){?>
                    <tr>
                        ...
                        <td>
                        <a href="index.php?page_layout=suaDanhMuc&id=<?php echo $row['idCategory']; ?>"><i class="fas fa-wrench"></i></a>
                        </td>
                        <td>
                            <a onclick="return Del('<?php echo $row['nameCategory'];?>')"  style = "color: red"  href="index.php?page_layout=xoaDanhMuc&id=<?php echo $row['idCategory']; ?>"><i class="fa fa-trash"></i></a>
                        </td>
         ...
         <a class="btn btn-primary" href="index.php?page_layout=themDanhMuc">Thêm mới</a>
