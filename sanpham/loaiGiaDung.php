...
<?php
    $sql = "SELECT * FROM types inner join category on types.idCategory = category.idCategory WHERE types.idCategory = 1" ;
...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a class= "active" href="index.php?page_layout=loaiGiaDung">Gia Dụng & Đời Sống</a>
