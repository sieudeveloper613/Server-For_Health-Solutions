...
<?php
    $sql = "SELECT * FROM types inner join category on types.idCategory = category.idCategory WHERE types.idCategory = 4" ;
    ...
    <div class="card" style = "color: #0088FF">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a class= "active" href="index.php?page_layout=loaiBachHoa">Bách Hóa Tổng Hợp </a>
          </div>
        </div>
