...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        ...
        <a class="active" href="index.php?page_layout=feedBack">FeedBack Khách Hàng</a>
            ...
            $i = 1;
                while($row = mysqli_fetch_assoc($query)){?>
                    <tr>
                        ...
                        <td><?php echo $row['contentFeedback']; ?></td>

                        <td>
                        <a href="index.php?page_layout=traLoi&id=<?php echo $row['idFeedback']; ?>"><i class="fa fa-send"></i></a>
                        </td>
                        <td>
                            <a onclick="return Del('<?php echo $row['nameCustomer'];?>')"  style = "color: red"  href="index.php?page_layout=xoaFeedback&id=<?php echo $row['idFeedback']; ?>"><i class="fa fa-trash"></i></a>
                        </td>
...
<script>
   function Del(name){
        return confirm("Bạn có chắc chắn muốn xóa feedback: " + name + "?");
   }
</script>
