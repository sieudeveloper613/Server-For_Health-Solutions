...
<?php    
    ...
    inner join types on product.idType = types.idType WHERE product.idCategory = 2;";                              
...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        <div class="card-header" >
            <h2 style = "text-align: center">Danh sách sản phẩm Sức Khỏe & Làm Đẹp</h2>
         </div>
         <div class="navbar">
         <div class="icon-bar">
         ...
         <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a class="active" href="index.php?page_layout=danhSachSucKhoe">Sức Khỏe & Làm Đẹp</a>
        ...
        <a href="index.php?page_layout=donHang">Đơn Hàng</a>
         ...
         <a class="btn btn-primary" href="index.php?page_layout=themSucKhoe">Thêm mới</a>
