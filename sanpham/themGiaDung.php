<?php
    $sql_brand = "SELECT * FROM category WHERE  idCategory = 1";
    $query_brand = mysqli_query($conn, $sql_brand);
    $sql_brand1 = "SELECT * FROM types WHERE idCategory = (SELECT idCategory FROM Category WHERE idCategory = 1)";
    ...
    if(isset($_POST['sbm'])){
        ...
        VALUES ('$nameProduct', '$imageProduct', $priceProduct,'$idCategory' ,'$idType', '$originProduct', '$branchProduct', '$contentProduct')";
            ...
            header ('location: index.php?page_layout=danhSachGiaDung');
    }
 ...
 <div class="container-fluid">
    <div class="card">
         <div class="card-header">
             <h2>Thêm sản phẩm Gia Dụng & Đời Sống </h2>
         </div>
         <div class="card-body">
