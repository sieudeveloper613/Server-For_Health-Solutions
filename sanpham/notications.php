...
<div class="container-fluid">
    <div class="card" style = "color: #0088FF">
        <div class="card-header" style = "text-align: center">
            <h2>Các tin nhắn đã trả lời khách hàng</h2>
         </div>
         <div class="navbar">
         <div class="icon-bar">
        ...
        <a class="active"  href="index.php?page_layout=notications">Trả Lời Khách Hàng</a>
         ...
         <table class="table table-striped">
            <thead>
                <tr style = "color: #0088FF">
                    ...
                    <th>Tiêu đề feedback</th>
                    <th>Tiêu đề trả lời</th>
            ...
            $i = 1;
                while($row = mysqli_fetch_assoc($query)){?>
                    <tr>
                        ...
                        <td><?php echo $row['titleFeedback']; ?></td>
                        <td><?php echo $row['titleNotification']; ?></td>
                        <td><?php echo $row['contentNotification']; ?></td>
                        <td><?php echo $row['reg_date']; ?></td>

                        <td>
                            <a onclick="return Del('<?php echo $row['nameCustomer'];?>')"  style = "color: red"  href="index.php?page_layout=xoaNotication&id=<?php echo $row['idNotification']; ?>"><i class="fa fa-trash"></i></a>
                        </td>
...
<script>
   function Del(name){
        return confirm("Bạn có chắc chắn muốn xóa câu trả lời tới: " + name + "?");
   }
</script>
